...
Studio provides crop data/keyframes, independent corner radii, border width/color and fit controls for both images and video. These additions and their crop, corner and border regressions await the deferred QA pass. Interactive source crop handles and animated bounding-box gizmos remain separate checklist work.
