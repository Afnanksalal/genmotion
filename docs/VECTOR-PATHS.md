...
Verification includes native fill pixels for every boolean operation and hole winding, expanded stroke caps, rounded corners, affine bounds, disjoint-contour trims, dashes, project-renderer integration, and Studio stack editing/persistence. Editable Bezier handles and a full shared-geometry dependency editor remain separate backlog work.
