...
The [2.4.0 milestone QA report](MILESTONE-QA-2026-09-07.md) records acceptance evidence and limits. A later provenance audit expanded the canonical program to 324 requirements; the current implementation and acceptance audit records **152/324** complete requirements. The 2.7.0 tranche adds versioned design specifications, creative preferences, reusable workflow bundles, expanded native audio DSP/timing, bounded product evidence capture, brand candidate extraction, provider-neutral acquisition, an integrated media ledger, reviewed transcription and reversible segmentation. Broader requirements stay open where their complete contracts remain unimplemented.
