...
The [2.4.0 milestone QA report](MILESTONE-QA-2026-09-07.md) records acceptance evidence and limits. A later provenance audit expanded the canonical program to 324 requirements; the current implementation and acceptance audit records **164/324** complete requirements. The 2.8.0 tranche adds deterministic resumable batch execution, a shared verified content store, offline semantic catalog search and local feedback, restricted-asset acceptance, native export rights enforcement and reversible reference preparation. Post-2.8 work adds delivery-purpose parity, full render attestations, declared adaptation provenance, hash-bound regional comparisons and reviewable reference observations compiled into native tracks. Broader requirements stay open where their complete contracts remain unimplemented.
