...
The [2.4.0 milestone QA report](MILESTONE-QA-2026-09-07.md) records acceptance evidence and limits. A later provenance audit expanded the canonical program to 324 requirements; the current implementation and acceptance audit records **167/324** complete requirements. The 2.8.0 tranche adds deterministic resumable batch execution, a shared verified content store, offline semantic catalog search and local feedback, restricted-asset acceptance, native export rights enforcement and reversible reference preparation. Later work adds delivery-purpose parity, full render attestations, declared adaptation provenance, hash-bound regional comparisons, reviewable reference observations, generated cross-surface contracts, lazy resumable domain skills and version-safe upgrades. Broader requirements stay open where their complete contracts remain unimplemented.
