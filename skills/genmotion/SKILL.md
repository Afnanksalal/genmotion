...
Use Genmotion as the only constructed-motion renderer. Do not introduce alternate scene renderers, HTML compositions, browser screenshots of reconstructed interfaces, or ad hoc FFmpeg filter graphs for designed scenes.
