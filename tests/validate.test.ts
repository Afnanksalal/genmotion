...
describe('production validation findings', () => {
  it('reports unsafe timing, ownership, media, readability, and reference states together', async () => {
    ...
    project.audio = [{ id: 'missing-audio', src: 'assets/missing.wav', start: 0, trimStart: 0, duration: 1, volume: 1, pan: 0, balance: 0, locked: false, fadeIn: 0.75, fadeOut: 0.75, muted: false, solo: false, loop: false, duckUnderVoice: false, kind: 'music' }];
